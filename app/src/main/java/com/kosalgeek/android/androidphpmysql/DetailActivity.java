...
public class DetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    EditText etName, etStatus, etImageUrl,etKategori, etDeskrip;
    ImageView ivImage;
    Button btnUpdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(product != null){
            etName.setText(product.post);
            etStatus.setText(product.status);
    ...
    public void onClick(View v) {
        ...
        postData.put("txtId_berita", "" + product.id_berita);
        postData.put("txtPost", etName.getText().toString());
        postData.put("txtStatus", etStatus.getText().toString());
        ...
        taskUpdate.execute("http://192.168.43.62/amikom/update.php");
    }
}
